                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                <div class="form-group ">
                                    ...
                                    <input type="text" autocomplete="off" name="usernameus" class="form-control" placeholder="Username">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="passwordus" autocomplete="off" name="password" class="form-control" placeholder="Password">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password2us" autocomplete="off" class="form-control" placeholder="Konfirmasi Password">
                                </div>
                                <br>
                                <div class="form-group">
